...
export function createResource(resource_data) {
	request({url: '../php/createResource.php', method: 'POST', data: {'resource': resource_data}}, function(err, response, body) {
		if (err) {
...
export function updateResource(resource_data) {
	request({url: '../php/updateResource.php', method: 'POST', data: {'resource': resource_data}}, function(err, response, body) {
		if (err) {
...
export function deleteResource(resource_id) {
	request({url: '../php/deleteResource.php', method: 'POST', data: {'id': resource_id}}, function(err, response, body) {
		if (err) {
...
export function createTag(tag_type, tag_data) {
	...
	request({url: '../php/createTag.php', method: 'POST', data: {'type': tag_type, 'tag': tag_data}}, function(err, response, body) {
		if (err) {
...
export function updateTag(tag_type, tag_data) {
	...
	request({url: '../php/updateTag.php', method: 'POST', data: {'type': tag_type, 'tag': tag_data}}, function(err, response, body) {
		if (err) {
...
export function deleteTag(tag_type, tag_id) {
	...
	request({url: '../php/deleteTag.php', method: 'POST', data: {'type': tag_type, 'id': tag_id}}, function(err, response, body) {
		if (err) {
